...
export default function QualificationSection({ motionConfig }) {
  return (
    <AnimatedSection
      ...
      background="bg-[radial-gradient(circle_at_70%_30%,rgba(167,139,250,0.14),transparent_32%)]"
    >
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-3">
          {qualification.map((item) => (
            <motion.div
              ...
              className="rounded-2xl border border-white/10 bg-[#0d1118]/85 p-7 backdrop-blur-xl transition hover:border-lime-300/35"
            >
              <div className="mb-6 grid h-11 w-11 place-items-center rounded-xl bg-lime-300/10 text-lime-200">
                <Icon name="target" />
              </div>
