export const pageGradient =
  "bg-[radial-gradient(circle_at_18%_14%,rgba(190,242,100,0.18),transparent_28%),radial-gradient(circle_at_82%_22%,rgba(34,211,238,0.16),transparent_28%),linear-gradient(145deg,rgba(8,13,23,0.96),rgba(3,7,18,0.98)_52%,rgba(12,18,26,1))]";
